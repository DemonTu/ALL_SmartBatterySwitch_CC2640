/**************************************************************************************************
  ...
  Description:    This file contains the Simple Network processor header 
 ...
 * CONSTANTS
 */
#define SNP_VERSION                           0x0100  //<! Version 1.0
...
void   SNP_eventToHost_send(uint16_t event, uint8_t *status, uint16_t sizeParam, 
                            uint8_t *param);
extern void SNP_stateChangeCB(gaprole_States_t newState);
