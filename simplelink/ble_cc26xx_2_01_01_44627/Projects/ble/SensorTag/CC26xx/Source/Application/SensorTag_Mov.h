...
// Callback event from main app to handle FSM related operations
#define SENSOR_FSM_CB_EVENT_RF          0
#define SENSOR_FSM_CB_EVENT_WF          1
#define SENSOR_FSM_CB_EVENT_NOTIFY_ALL  2
#define SENSOR_FSM_CB_EVENT_NOTIFY_OB   3   
