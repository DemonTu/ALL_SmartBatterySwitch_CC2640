...
/ Sep 14,'12 tisb   Added _VOLUMES check for FatFS initialization (SDOCM00094671)
/---------------------------------------------------------------------------*/
...
#if _VOLUMES == 4
static
FATFS *FatFs[_VOLUMES] = {0,0,0,0};     /* Pointer to the file system objects (logical drives) */
#else
#error Number of initializers must match _VOLUMES.
#endif
