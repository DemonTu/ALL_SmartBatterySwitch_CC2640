...
public class ti_sysbios_family_arm_cc32xx
{
    ...
    void Timer$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.cc32xx.Timer.Module_State", null);
                ...
                po.addFld("period64", Proto.Elm.newCNum("(xdc_UInt64)"), $$UNDEF, "w");
                po.addFldV("clockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc32xx"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_clockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc32xx"), $$DEFAULT, "w");
    }
